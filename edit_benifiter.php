...
<div id="model_content" class="modal-body">
    ...
    <div class="form-group col-3">
        ...
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text"><i class="fas fa-ghost"></i></span>
            </div>
            <input type="text" class="form-control" name="txt_name" id="txt_name" placeholder="Enter farmer name"
    ...
    <div class="row">
        <div class="form-group col-3">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="txt_nic_no" id="txt_nic_no" placeholder="Enter NIC No"
                    value="<?php echo $nic_no; ?>" required>
            </div>
        </div>
    ...
    <div class="form-group col-3" style="display: none;">
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control" name="txt_target" id="txt_target" placeholder="Enter Target"
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control" name="txt_address" id="txt_address" placeholder="Enter Address"
    ...
    <div class="row">
        <div class="form-group col-3">
            ...
            <div class="input-group">
                ...
                <input type="text" onkeydown="return isNumber(event);" maxlength="10" class="form-control short"
                    name="txt_contact_number" id="txt_contact_number" placeholder="Enter Contact No"
        ...
        <div class="form-group col-3">
            ...
            <div class="input-group">
                ...
                <select class="selectpicker form-control" data-live-search="true" title="Select Society"
                    name="cmb_society" id="cmb_society">
                    <?php
                if($district_id > 0)
                {
                ...
                ?>
                    <option data-tokens="<?php echo $dist_sos->name; ?>" value="<?php echo $dist_sos->id; ?>"
                        <?php echo ($society_id == $dist_sos->id) ? "selected" :"";?>><?php echo $dist_sos->name; ?>
                    </option>
                    <?php
                    }
                }
    ...
    <div class="row">
        ...
        <div class="form-group col-3">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="txt_branch_name" id="txt_branch_name"
                    placeholder="Enter Branch Name" value="<?php echo $branch_name; ?>">
            </div>
        </div>
        ...
        <div class="form-group col-3">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="txt_branch_code" id="txt_branch_code"
                    placeholder="Enter Branch Code" value="<?php echo $branch_code; ?>">
            </div>
        </div>
        ...
        <div class="form-group col-3">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="txt_account_no" id="txt_account_no"
                    placeholder="Enter Account Number" value="<?php echo $account_number; ?>" required>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div id="spouse" class="panel-collapse collapse" style="padding-top: 10px;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="spouse_name" id="spouse_name"
                                    placeholder="Enter spouse name" value="<?php echo $spouse_name; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="spouse_nic_no" id="spouse_nic_no"
                                    placeholder="Enter Spouse NIC No" value="<?php echo $spouse_nic_no; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control short" name="spouse_gender" id="spouse_gender">
                                    <option value="M" <?php echo ($spouse_gender == "M") ? "selected" :"";?>>Male
                                    </option>
                                    <option value="F" <?php echo ($spouse_gender == "F") ? "selected" :"";?>>Female
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="date" class="form-control short" name="spouse_dob" id="spouse_dob"
                                    value="<?php echo $spouse_dob; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="spouse_highest_edu_level">Education
                                Level:</label>
                            <div class="col-sm-10">
                                <select class="form-control short" name="spouse_highest_edu_level"
                                    id="spouse_highest_edu_level">
                                    <option value="Ordinary Level School"
                                        <?php echo ($spouse_highest_edu_level == "Ordinary Level School") ? "selected" :"";?>>
                                        Ordinary Level School</option>
                                    <option value="Advance Level School"
                                        <?php echo ($spouse_highest_edu_level == "Advance Level School") ? "selected" :"";?>>
                                        Advance Level School</option>
                                    <option value="Higher Education Diploma"
                                        <?php echo ($spouse_highest_edu_level == "Higher Education Diploma") ? "selected" :"";?>>
                                        Higher Education Diploma</option>
                                    <option value="University Degree"
                                        <?php echo ($spouse_highest_edu_level == "University Degree") ? "selected" :"";?>>
                                        University Degree</option>
                                    <option value="Master's Degree"
                                        <?php echo ($spouse_highest_edu_level == "Master's Degree") ? "selected" :"";?>>
                                        Master's Degree</option>
                                    <option value="Doctorate"
                                        <?php echo ($spouse_highest_edu_level == "Doctorate") ? "selected" :"";?>>
                                        Doctorate</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="spouse_is_fulltime_employee" id="spouse_is_fulltime_employee"
                                    type="checkbox"
                                    <?php echo ($spouse_is_fulltime_employee == "Y") ? "checked" :"";?> />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="spouse_is_parttime_emaployee" id="spouse_is_parttime_emaployee"
                                    type="checkbox"
                                    <?php echo ($spouse_is_parttime_emaployee == "Y") ? "checked" :"";?> />
            ...
            <div id="dependant" class="panel-collapse collapse" style="padding-top: 10px;">
                ...
                <fieldset>
                    ...
                    <div class="form-group" style="display: none;">
                        ...
                        <div class="col-sm-10">
                            <input type="text" disabled="true" class="form-control" name="txt_dependant_id"
                                id="txt_dependant_id">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="txt_dependant_name" id="txt_dependant_name"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="txt_dependant_nic_no"
                                id="txt_dependant_nic_no" placeholder="Enter NIC Number">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="date" class="form-control short" name="dtp_dependant_dob"
                                id="dtp_dependant_dob" value="<?php echo $spouse_dob; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="cmb_dependant_highest_edu_level">Education
                            Level:</label>
                        <div class="col-sm-10">
                            <select class="form-control short" name="cmb_dependant_highest_edu_level"
                                id="cmb_dependant_highest_edu_level">
                                <option value="Ordinary Level School"
                                    <?php echo ($spouse_highest_edu_level == "Ordinary Level School") ? "selected" :"";?>>
                                    Ordinary Level School</option>
                                <option value="Advance Level School"
                                ...
                                <option value="Master's Degree"
                                    ...
                                    Master's Degree</option>
                                <option value="Doctorate"
                                    <?php echo ($spouse_highest_edu_level == "Doctorate") ? "selected" :"";?>>Doctorate
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="chk_dependant_is_fulltime_employee" id="chk_dependant_is_fulltime_employee"
                                type="checkbox" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="chk_dependant_is_parttime_emaployee" id="chk_dependant_is_parttime_emaployee"
                                type="checkbox" />
                    ...
                    <div class="form-group">
                        <div class="col-sm-10">
                            <button id="btn_add_dependant" class="btn-primary btn-sm fa" type="button">Add
                                another</button>
                            <button id="btn_save_dependant" class="btn-primary btn-sm fa" type="button"
                                style="display: none;">Save dependant</button>
                        </div>
                    </div>
                </fieldset>
            </div>
            ...
            <div id="permit" class="panel-collapse collapse">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="selectpicker" data-live-search="true" title="Select Crop" id="cmb_crop"
                                name="cmb_crop" required>
                                <?php
                                    $data_crops = callService("/get_all_crops");
                                    foreach ($data_crops as $crop) {
                                ?>
                                <option value="<?php echo $crop->id; ?>"
                                    <?php echo ($crop->id == 1) ? "selected" :"";?>><?php echo $crop->name; ?></option>
                                <?php
                                    }
                                ?>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="txt_permit_no"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="txt_land_name" placeholder="Enter Land Name"
                                value="<?php echo $land_name; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="txt_plot_no">Plot No:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control short" id="txt_plot_no" placeholder="Enter Plot No"
                                value="<?php echo $plot_no; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="txt_land_size_init_ha">Land Size Init:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control short" id="txt_land_size_init_ha"
                                onkeydown="return isNumber(event);" placeholder="Enter Land Size in ha">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="txt_land_size_act_ha">Land Size Actual:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control short" id="txt_land_size_act_ha"
                                onkeydown="return isNumber(event);" placeholder="Enter Actual Land Size in ha">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="cmb_district">District:</label>
                        <div class="col-sm-3">
                            <select class="selectpicker" data-live-search="true" title="Select District"
                                id="cmb_district">
                                <?php
                                        $data_district = callService("/get_all_districts?uid=$curr_uid");
                                        foreach ($data_district as $dist) {
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <select class="selectpicker" data-live-search="true" title="Select TI Range"
                                id="cmb_ti_range">
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-10">
                            ...
                            <button id="btn_save_permit" class="btn-primary btn-sm fa" type="button"
                                style="display: none;">Save permit</button>
                        </div>
                    </div>
                </fieldset>
            </div>
